...
echo apply_filters( 'woocommerce_loop_add_to_cart_link',
    sprintf( '<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="ajax_add_to_cart %s product_type_%s"><span class="o-neuron-hover-holder__button__cart">%s</span><span class="o-neuron-hover-holder__button__loader h-rotatingNeuron">%s</span><span class="o-neuron-hover-holder__button__added">%s</span></a>',
        ...
        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check"><polyline points="20 6 9 17 4 12"></polyline></svg>'
    ),
$product );