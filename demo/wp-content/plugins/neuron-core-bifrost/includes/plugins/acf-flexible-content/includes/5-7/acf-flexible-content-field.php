...
class acf_field_flexible_content extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'acf-input-flexible-content', acf_get_external_dir(__FILE__, 'js/input.js'), array('acf-input') );
		wp_enqueue_style( 'acf-input-flexible-content', acf_get_external_dir(__FILE__, 'css/input.css'), array('acf-input') );
	...
	*/
	...
	function field_group_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'acf-field-group-flexible-content', acf_get_external_dir(__FILE__, 'js/field-group.js'), array('acf-field-group') );
		wp_enqueue_style( 'acf-field-group-flexible-content', acf_get_external_dir(__FILE__, 'css/field-group.css'), array('acf-field-group') );
