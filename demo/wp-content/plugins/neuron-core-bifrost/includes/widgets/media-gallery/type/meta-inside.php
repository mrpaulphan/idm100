            ...
            <div class="<?php echo esc_attr(implode(' ', $neuron_hover_holder_body_class)) ?>">
                <div class="o-neuron-hover-holder__body-meta">
                    <?php if ($media['query_title']) : ?>
                        <h4 class="o-neuron-hover__body-meta__title"><?php echo esc_attr($media['query_title']); ?></h4>
                    <?php endif; ?>
                    <?php if ($media['query_subtitle']) : ?>
                        <h5 class="o-neuron-hover__body-meta__subtitle"><?php echo esc_attr($media['query_subtitle']) ?></h5>
                    <?php endif; ?>
